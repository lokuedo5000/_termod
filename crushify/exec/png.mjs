...
class ImageConverter {
  ...
  async processFile(filePath, options) {
    try {
      ...
      const outputPath = path.join(options.dest, `${fileName}.png`);
      ...
      // Convertir la imagen
      await sharp(filePath).png(pngOptions).toFile(outputPath);
...
export default async function toPNG(event, args) {
